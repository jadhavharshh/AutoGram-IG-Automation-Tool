...
const Footer = () => {
  return (
    <div className="border-t border-neutral-800 px-8 pt-20  relative bg-black">
      <div className=" mx-auto text-sm text-neutral-400 flex sm:flex-row flex-col justify-between items-start">
        <div>
          <div className="mr-4 md:flex mb-4">
            <a
              ...
              href="/"
            >
              <div className="h-5 w-6 bg-white rounded-br-lg rounded-tr-sm rounded-tl-lg rounded-bl-sm"></div>
              <span className="font-medium text-white">AutoGram</span>
            </a>
          </div>
